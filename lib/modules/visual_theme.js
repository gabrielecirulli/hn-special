...
HNSpecial.settings.registerModule("visual_theme", function () {
  ...
  function replaceArrows() {
    ...
    var upArrow = chrome.runtime.getURL(isDark ? "resources/arrow-up-white.svg" : "resources/arrow-up-black.svg");
    var downArrow = chrome.runtime.getURL(isDark ? "resources/arrow-down-white.svg" : "resources/arrow-down-black.svg");
    var arrowPicture;
