...
HNSpecial.settings.registerModule("visual_theme", function () {
  ...
  if (ignore.indexOf(location.pathname) === -1) {
    ...
    if (logo) {
      ...
      logo.setAttribute("src", HNSpecial.firefox.data.url("resources/logo.svg"));
    }
  ...
  function replaceArrows() {
    ...
    var upArrow = HNSpecial.firefox.data.url("resources/arrow-up.svg");
    var downArrow = HNSpecial.firefox.data.url("resources/arrow-down.svg");
    var arrowPicture;
