function Settings() {
  ...
  // Load the settings
  _.request(firefox.data.url("lib/defaults.json"), "GET", function (code) {
...
Settings.prototype.buildMenuFrame = function (container, showTip) {
  ...
  button.appendChild(_.createElement("img", {
    ...
    attributes: {
      src: firefox.data.url("resources/gear.svg")
    }
  }));
  ...
  var complete = function () {
    ...
    var iframe = _.createElement("iframe", {
      ...
      attributes: {
        ...
        src: firefox.data.url("lib/extras/permissions.html#" + moduleName)
      }
    });
