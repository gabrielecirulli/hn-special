function Settings() {
  ...
  // Load the settings
  _.request(HNSpecial.firefox.data.url("lib/defaults.json"), "GET", function (code) {
...
Settings.prototype.buildMenuFrame = function (container, showTip) {
  ...
  button.appendChild(_.createElement("img", {
    ...
    attributes: {
      src: HNSpecial.firefox.data.url("resources/gear.svg")
    }
  }));
    ...
    var complete = function () {
      ...
      var iframe = _.createElement("iframe", {
        ...
        attributes: {
          ...
          src: HNSpecial.firefox.data.url("lib/extras/permissions.html#" + moduleName)
        }
      });
...
(function () {
  ...
  this.HNSpecial.firefox = require("sdk/self");
}).call(this);
