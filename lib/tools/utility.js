(function () {
  ...
  _.isTitleLink = function (link) {
    return link.parentElement.classList.contains("title") && !link.getAttribute("href").match(/^(news|newest|newcomments|threads|show|ask|jobs)\?\S+/) && !link.classList.contains("hnspecial-infinite-pause");
  };
