(function () {
  ...
  _.isTitleLink = function (link) {
      return link.parentElement.classList.contains("title") && !link.getAttribute("href").match(/.*?news\?/) && !link.classList.contains("hnspecial-infinite-pause");
  };
  ...
  _.isListingPage = function () {
    var title = document.getElementsByClassName("title")[0];
    return title && title.childElementCount === 1 && title.parentElement.childElementCount === 3;
  };
